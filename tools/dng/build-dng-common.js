...
,   pth  = require("path")
,   b    = require("./builder")
,   version = JSON.parse(fs.readFileSync(pth.join(__dirname, "./package-dng.json"), "utf-8")).version
,   builds = pth.join(__dirname, "../../builds/dng")
,   latest = pth.join(builds, "respec-dng-common.js")
;
...
function buildOASIS (versionSnapshot, cb) {
    ...
    var versioned = pth.join(builds, "respec-dng-common-" + opts.version + ".js");
