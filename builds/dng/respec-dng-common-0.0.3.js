...
define(
    'dng/headers',["handlebars"
    ,"core/utils"
    ,"tmpl!dng/templates/headers.html"
    ,"tmpl!dng/templates/sotd.html"
    ,"tmpl!dng/templates/notices.html"
    ],
    function (hb, utils, headersTmpl, sotdTmpl, noticesTmpl) {
        ...
        ,   run:    function (conf, doc, cb, msg) {
                ...
                if (!conf.license) conf.license = "dng";
                ...
                // conf.latestVersion = "http://docs.dng-open.org/" + conf.wgShortName + "/";
                if (conf.previousPublishDate) {
                    ...
                    conf.prevVersion = "http://docs.dng-open.org/" + conf.wgShortName + "/" + conf.previousPublishDate.getFullYear() + "/" + pmat + "-" +
                ...
                if (conf.prevRecShortname && !conf.prevRecURI) conf.prevRecURI = "http://docs.dng-open.org/" + conf.prevRecShortname;
                ...
                if (conf.doRDFa) {
                    ...
                    var prefixes = "bibo: http://purl.org/ontology/bibo/ dng: http://docs.dng-open.org/ns/spec";
                    if (conf.doRDFa != '1.1') {
